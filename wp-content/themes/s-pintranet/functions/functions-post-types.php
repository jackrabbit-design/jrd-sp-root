...
$postNameSlug     = 'news'; // Name of post type
...
$taxonomyNameSlug     = 'news-types';
$taxonomyNameSingular = 'News Types';
...
// Sample Register Post
$postName         = 'Profiles'; // Name of post type
$postNameSlug     = 'profile'; // Name of post type
$postNameSingular = 'Profile'; // Singular Name
$postNamePlural   = 'Profiles'; // Plural Name
register_post_type(
	$postNameSlug, array(
		'labels' => array(
	       'name' => $postName,
		...
		'capabilities' => array(
			...
			'edit_post' => 'edit_profiles',
			'delete_post' => 'delete_profiles',
			'read_post' => 'read_profiles',
		),
		'hierarchical' => true,
		'rewrite' => array('slug' => $postNameSlug),
		'query_var' => true,
